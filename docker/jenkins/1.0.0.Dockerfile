...
RUN jenkins-plugin-cli --plugins dark-theme:524.vd675b_22b_30cb_
RUN jenkins-plugin-cli --plugins pipeline-graph-view:619.v92f3fcdc39db_
RUN jenkins-plugin-cli --plugins github:1.44.0
